        ...
        try:
            ...
            if not df.empty:
                ...
                with c1:
                    ...
                    st.write(f"● **市場熱度**：{'大家瘋了！現在進場容易套在山頂' if k_val > 80 else '冷冷清清，反而可以趁現在偷偷撿便宜' if k_val < 20 else '氣氛很穩，適合分批買'}")
